                                ...
                                <div class="w-40 min-w-full">
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input
                                            ...
                                            placeholder="{{ $municipality['price'] }}" aria-describedby="price-currency" wire:model="municipalities.{{ $key }}.price">
                                        <div
