                ...
                <div class="mt-6 grid grid-cols-1 row-gap-6 col-gap-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="name" type="text"
                                ...
                                wire:model.lazy="client.name" autocomplete="off">
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="email" type="email"
                                class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                wire:model.lazy="client.email" autocomplete="off">
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="phone" type="text"
                                class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                wire:model.lazy="client.contact_number" autocomplete="off">
                        </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="homepage"
                                class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                wire:model.lazy="client.homepage_url">
                        </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <textarea id="about" rows="3"
                                ...
                                wire:model.lazy="client.about"></textarea>
                        </div>
                        <p class="mt-2 text-sm text-gray-500">Write a few sentences about the client.</p>
                    </div>

                    <x-dashboard-clients-logo :logo="$logo" :client="$client">
                        </x-dashboard.clients.logo>
                </div>
            </div>
            ...
            <div class="flex justify-end">
                ...
                <span class="ml-3 inline-flex rounded-md shadow-sm">
                    <button type="submit"
                        ...
                        wire:click.prevent="createClient">
                        Create
                    </button>
                </span>
            </div>
